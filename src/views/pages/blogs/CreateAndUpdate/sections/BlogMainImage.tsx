...
const BlogMainImage = ({ mainImage }: { mainImage?: GalleryItem | null }) => {
  ...
  return (
    <Card>
      <CardHeader title='تصویر اصلی وبلاگ' />
              ...
              <>
                {selectedImage ? (
                  <Box sx={{ position: 'relative', width: 200, height: 200, borderRadius: 2, overflow: 'hidden', boxShadow: 1 }}>
                    <Image src={selectedImage.fileUrl} alt={selectedImage.title || 'تصویر وبلاگ'} fill style={{ objectFit: 'cover' }} />
